...
class TopAgent(Skeleton):

    def __init__(self):
        self.file_name = "top_agent"
    ...
    def html(self):
        ...
        ## Ships
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Ships destroyed</h2></div></div>"
        ...
        ## ISK
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>ISK destroyed</h2></div></div>"
