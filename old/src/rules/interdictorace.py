...
class InterdictorAce(Skeleton):
    ...
    def __init__(self):
        self.file_name = "interdictor_ace"
    ...
    def html(self):
        ...
        ## Ships
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top Interdictor(+HIC) pilots <small>Ships destroyed</small></h2></div></div>"
        ...
        ## ISK
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top Interdictor(+HIC) pilots <small>ISK destroyed</small></h2></div></div>"
