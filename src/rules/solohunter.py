...
class SoloHunter(Skeleton):
    ...
    def html(self):
        ...
        ## Ships
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top solo pilots <small>Ships destroyed</small></h2></div></div>"
        ...
        ## ISK
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top solo pilots <small>ISK destroyed</small></h2></div></div>"
