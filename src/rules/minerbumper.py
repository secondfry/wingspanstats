...
class MinerBumper(Skeleton):
    ...
    def __str__(self):
        ...
        output += "Top miner hunters - ships destroyed\n"
        output += "--------------------------------------------\n"
        place = 0
        for w in sorted(
                self.agent_ships_destroyed,
        ...
        output += "Top miner hunters - ISK destroyed\n"
        output += "--------------------------------------------\n"
        place = 0
        for w in sorted(
                self.agent_isk_destroyed,
    ...
    def html(self):
        ...
        ## Ships
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top miner hunters <small>Ships destroyed</small></h2></div></div>"
        ...
        ## ISK
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top miner hunters <small>ISK destroyed</small></h2></div></div>"
