...
class ExplorerHunter(Skeleton):
    ...
    def __init__(self):
        self.file_name = "explorer_hunter"
    ...
    def html(self):
        ...
        ## Ships
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top explorer hunters <small>Ships destroyed</small></h2></div></div>"
        ...
        ## ISK
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top explorer hunters <small>ISK destroyed</small></h2></div></div>"
