...
class Recons(Skeleton):
    ...
    def __str__(self):
        ...
        output += "Top Recon pilots - ships destroyed\n"
        output += "--------------------------------------------\n"
        place = 0
        for w in sorted(
                self.agent_ships_destroyed,
        ...
        output += "Top Recon pilots - ISK destroyed\n"
        output += "--------------------------------------------\n"
        place = 0
        for w in sorted(
                self.agent_isk_destroyed,
    ...
    def html(self):
        ...
        ## Ships
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top Recon pilots <small>Ships destroyed</small></h2></div></div>"
        ...
        ## ISK
        # Title
        output += "<div class=\"row\"><div class=\"col-xs-12\"><h2>Top Recon pilots <small>ISK destroyed</small></h2></div></div>"
    ...
    def process_km(self, killmail):
        ...
        for attacker in killmail['attackers']:
            ...
            if attacker_name != "" and attacker_corp in StatsConfig.CORP_IDS:
                if attacker_ship in [11969, 11957, 11965, 11963, 20125, 11961, 11971, 11959]:
